...
def calculate_principal_values(vec: np.ndarray, quantity: str = "strain") -> np.ndarray:
    ...
    This function converts the input Voigt vector into a symmetric 3x3 tensor 
...
def voigt_to_tensor(vec: np.ndarray, quantity: str = "strain") -> np.ndarray:
    """Converts a 6-component Voigt vector into a 3x3 symmetric tensor.
    
    This function transforms engineering strain or stress vectors from Voigt notation:
    [xx, yy, zz, xy, yz, xz]ᵀ into a 3x3 symmetric tensor. The shear terms are treated
    ...
    Returns:
        np.ndarray: A 3x3 symmetric tensor.
